...
async def main():
    ...
    )  # Получаем токен бота из файла с конфигом
    ...
    scheduler.add_job(
        job, "cron", day_of_week="mon-sun", hour=7, minute=00, args=(bot.send_message,)
    )
    ...
    )  # Игнорируем все команды, отправленные до запуска бота
