...
1. Попросите студентов Вашей группы зарегестрироваться. Вам нужно просто отправить в беседу группы ссылку на бота и подождать, пока группа пройдет регистрацию.
