...
def include_show_tomorrow_schedule_callback(root_router: RootRouter) -> None:
    root_router.include_router(choose_lesson_callback_router)


@choose_lesson_callback_router.callback_query(F.data == "show_schedule_tomorrow")
async def show_tomorrow_schedule_callback(
