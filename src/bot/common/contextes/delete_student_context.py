...
class DeleteStudentContext:
    ...
    async def telegram_id(self) -> int:
        ...
        assert telegram_id is not None, "You must have settled telegram before."
        return telegram_id
    ...
    async def last_name(self) -> str:
        ...
        assert last_name is not None, "You must have settled last_name before."
        return last_name
    ...
    async def first_name(self) -> str:
        ...
        assert first_name is not None, "You must have settled first_name before."
        return first_name
    ...
    async def group_name(self) -> str:
        ...
        assert group_name is not None, "You must have settled group_name before."
        return group_name
