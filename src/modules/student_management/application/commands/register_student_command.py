...
from src.modules.student_management.application.repositories.create_student_dto import CreateStudentDTO
...
class RegisterStudentCommand(UseCase):
    ...
    async def execute(self, telegram_id: int, create_student_data: CreateStudentDTO) -> Student:
