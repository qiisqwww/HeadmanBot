...
SQL_LOGGING_PATH = Env("SQL_LOGGING_PATH", Path)
INFO_LOGGING_PATH = Env("INFO_LOGGING_PATH", Path)
ERROR_LOGGING_PATH = Env("ERROR_LOGGING_PATH", Path)
...
CELERY_RESULT_BACKEND = Env("CELERY_RESULT_BACKEND", str)
